// Setup admin authentication and test return to dashboard button
...
// Navigate to admin investments page
console.log('🔄 Navigating to admin investments page...');
window.location.href = '/admin/investments';

console.log('🎯 Setup completed! Check the admin investments page for the return to dashboard button.'); 
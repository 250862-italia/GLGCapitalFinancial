...
let TEMP_CLIENTS: Client[] = [
  ...
  },
  {
    ...
    usdt_wallet: 'TQn9Y2khDD95J42FQtQTdwVVRqjqjqjqjq2',
    status: 'active',
    risk_profile: 'low',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    ...
    bic: 'UNCRIT2AXXX',
    account_holder: 'Marco Verdi',
    usdt_wallet: 'TQn9Y2khDD95J42FQtQTdwVVRqjqjqjqjq3',
    status: 'pending',
    risk_profile: 'high',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
...
async function checkDatabaseConnection(): Promise<boolean> {
  try {
    console.log('🔍 Database connection check - testing investments table...');

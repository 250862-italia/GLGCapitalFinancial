        ...
        <div className="p-6 space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-blue-900 mb-1">Come funziona l'investimento</h4>
                <p className="text-blue-800 text-sm">
                  Dopo aver confermato, creeremo il tuo investimento e ti invieremo le istruzioni di pagamento via email. 
                  Una volta ricevuto il pagamento, il tuo investimento sarà attivato automaticamente.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              {loading ? (
                <div className="flex items-center space-x-2">
                  ...
                  <span>Creando investimento...</span>
                </div>
              ) : (
                <div className="flex items-center space-x-2">
                  ...
                  <span>Conferma Investimento</span>
                </div>
              )}
            </button>
          </div>

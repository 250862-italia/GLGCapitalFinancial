-- Creazione tabelle mancanti per GLGCapitalFinancial (VERSIONE CORRETTA)
...
-- 2. Tabella team per gestione team (user_id opzionale)
...
-- 12. Inserisci dati di esempio per team (SENZA user_id per evitare foreign key constraint)

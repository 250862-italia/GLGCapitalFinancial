-- Fix Profiles Table Structure - FINAL VERSION
...
-- 4. Drop existing policies for profiles (if they exist)
...
-- 8. Create clients table if it doesn't exist
...
-- 9. Enable RLS for clients
ALTER TABLE clients ENABLE ROW LEVEL SECURITY;

-- 10. Drop existing policies for clients (if they exist)
...
-- 16. Create function to handle new user registration (WITHOUT TRIGGER)
...
-- 17. Verify the setup
SELECT 'Profiles table structure fixed successfully! No automatic trigger created.' as status; 
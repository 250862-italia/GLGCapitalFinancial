        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed">
              <strong>Empower your vision.</strong> Through our premium share-pledge framework, 
              trailblazing enterprises harness strategic capital to dominate tomorrow's markets—fueling 
              exponential growth, unshakable resilience, and enduring legacy.
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive financial solutions designed for modern enterprises and investors.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Professional financial services and investment solutions. Specializing in equity pledge systems and corporate financing.
              </p>
            </div>

      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mt-20 text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-16">
          ...
          <p className="text-2xl text-white/90 mb-10">
            Book a complimentary consultation with one of our investment specialists.
          </p>
          <button className="bg-white text-blue-600 px-12 py-4 rounded-xl text-xl font-bold hover:bg-gray-100 transition-colors shadow-2xl">
            Book Consultation
          </button>
        </div>
      </div>

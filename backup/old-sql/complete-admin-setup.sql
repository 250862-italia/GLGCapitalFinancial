...
-- Run this script in Supabase SQL Editor to complete the setup
...
INSERT INTO public.team_members (user_id, first_name, last_name, email, role, department, status) VALUES
(gen_random_uuid(), 'John', 'Doe', 'john.doe@glgcapital.com', 'Senior Manager', 'Operations', 'active'),
(gen_random_uuid(), 'Jane', 'Smith', 'jane.smith@glgcapital.com', 'Analyst', 'Research', 'active'),
(gen_random_uuid(), 'Mike', 'Johnson', 'mike.johnson@glgcapital.com', 'Director', 'Sales', 'active')
